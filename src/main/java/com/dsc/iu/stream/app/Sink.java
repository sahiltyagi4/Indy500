...
public class Sink extends BaseRichBolt implements MqttCallback {
	...
	//private HashMap<String,CombinedTuple> cache= new HashMap<>();
	/**
	 * 
	 */
	...
	private ConcurrentHashMap<String, String> recordaccumulate;
...
//			headarr.p
//			recordaccumulate.put(carnum+"_"+counter, )
		}
	...
	public void prepare(Map arg0, TopologyContext arg1, OutputCollector arg2) {
		...
		recordaccumulate = new ConcurrentHashMap<String, String>();
