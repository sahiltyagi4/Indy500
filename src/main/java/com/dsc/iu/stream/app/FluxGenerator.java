...
public class FluxGenerator {
    ...
    private static final String TEMPLATE_BOLTS = "  - id: \"RPMBolt-#NO\"\n" +
            "    className: \"com.dsc.iu.stream.app.TestHTMBolt\"\n" +
            "    parallelism: 1\n" +
            "    constructorArgs:\n" +
//            "      - \"#NO\"\n" +
            "      - \"RPM\"\n" +
...
//            "      - \"#NO\"\n" +
    ...
    public static void main(String[] args) throws IOException {
        ...
        bolts.append("  - id: \"sink\"\n" +
                "    className: \"com.dsc.iu.stream.app.TestSink\"\n" +
                "    parallelism: 1\n\n");
        ...
        FileWriter fileWriter = new FileWriter(new File("/Users/sahiltyagi/Desktop/fluxfile.yaml"));
