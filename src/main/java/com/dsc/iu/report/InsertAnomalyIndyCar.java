...
public class InsertAnomalyIndyCar {
	...
	public static void main(String[] args) {
		try {
			...
			rdr = new BufferedReader(new InputStreamReader(new FileInputStream(new File("/Users/sahiltyagi/Desktop/dixon_noZeros.log"))));
			...
			for(int i=0; i<100; i++) {
				int record_num = seed.nextInt(16934);
