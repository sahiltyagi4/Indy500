...
//		}
	...
	public void execute(Tuple input) {
		...
		executeTupleIndex++;
//		executiontime.println(executeTupleIndex + "," + input.getStringByField("record").split(",")[1] + "," + System.currentTimeMillis());
		//System.out.println("$$$$$$$$$$$," + executeTupleIndex + "," + input.getStringByField("record").split(",")[1] + "," + System.currentTimeMillis());
		manualpublish.onNext(input.getStringByField("record"));
//		if(executeTupleIndex == 17263) {
//			executiontime.close();
//		}
